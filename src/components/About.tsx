        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <p className="text-lg text-gray-700 leading-relaxed">
              <span className="font-semibold text-pink-700">SweetyLab</span> è un atelier dedicato alla creazione di abiti da sposa su misura. Eleonora e Veronica uniscono esperienza e passione per realizzare abiti unici, curati nei minimi dettagli, garantendo professionalità e serenità in ogni fase del tuo percorso.
            </p>
            ...
            <div className="grid grid-cols-1 gap-6 pt-6">
              ...
              <div className="flex gap-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center">
                <Scissors className="w-6 h-6 text-pink-600" strokeWidth={1.5} />
                  </div>
                </div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center">
                <Users className="w-6 h-6 text-pink-600" strokeWidth={1.5} />
                  </div>
                </div>
                <div>
